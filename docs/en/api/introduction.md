...
**Detailed examples** (description + request + response per endpoint): see Russian pages under `/ru/api/` — e.g. [products](/ru/api/products.md), [orders](/ru/api/orders.md). English tables mirror the contract; full HTTP examples are maintained in RU first.
