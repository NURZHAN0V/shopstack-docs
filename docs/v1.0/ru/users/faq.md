...
На этом портале: раздел [API](/v1.0/ru/api/introduction) — описание ручек, примеры запросов и ответов. Отдельный Swagger на бэкенде для чтения docs не нужен.
...
- Портал docs: [История изменений](/v1.0/ru/versions/changelog)

## Тёмная тема панели

Переключатель в меню пользователя сайдбара — [Тема панели](/v1.0/ru/theme/admin-ui-theme.md).
