...
- [API reference](/v1.0/en/api/introduction) on this portal (no backend required to read docs)
...
[Portal changelog](/v1.0/en/versions/changelog) and `goshop/CHANGELOG.md`.

## Dark theme

[Admin UI theme](/v1.0/en/theme/admin-ui-theme.md).
